...
import { useLocalStorage } from "@/components/Header/hooks/useLocalStorage";
...
export default function Cart(){
    ...
    const cartTotal = formatValor(calculateTotal(value))
    const deliveryFee = 4000;
    const cartTotalWithDelivery = formatValor(calculateTotal(value) + deliveryFee)
